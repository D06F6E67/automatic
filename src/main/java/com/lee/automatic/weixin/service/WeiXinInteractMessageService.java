...
public class WeiXinInteractMessageService {
    ...
    @Resource
    private WeiXinSendAiReply weiXinSendAiReply;
     ...
     * 消息接收和回复
     */
    public void receiveReplyMessage(String msgSignature, String timestamp, String nonce, String body) {
        ...
        try {
            ...
            weiXinSendAiReply.swap(content, getElementByName(root, "FromUserName"));
